                ...
                <div className="max-w-7xl mx-auto px-6 py-24 flex flex-col items-center justify-center relative z-10">
                    <div className="text-center w-full max-w-4xl">
                        ...
                        <p className="text-xl md:text-2xl text-gray-100 mb-12 max-w-2xl mx-auto leading-relaxed">
                            Journey into Ayurveda with personalized quizzes, natural remedies,
                            and a holistic lifestyle tailored to your unique Prakriti.
                        </p>
                        <button
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-12">
                            <div className="flex-1 text-left">
                                ...
                                <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                                    Prakriti, in Ayurveda, is your unique mind-body constitution,
                                    determined at birth by the balance of the three Doshas: Vata,
                                    Pitta, and Kapha. It reflects your inherent traits, strengths,
                                    and tendencies, shaping how you interact with the world and
                                    maintain health. Understanding your Prakriti helps tailor
                                    lifestyle choices for optimal well-being and harmony.
                                </p>
                                <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                                    These Doshas are deeply connected to the human body: Vata
                                    governs movement and is linked to the nervous system and
                                    circulation; Pitta controls metabolism and digestion,
                                    influencing the endocrine and digestive systems; Kapha
                                    provides structure and lubrication, supporting the
                                    musculoskeletal and immune systems. This interplay ensures a
                                    balanced state when in harmony.
                                </p>
                            </div>
            ...
            <div id="lifestyle-tips" className="max-w-7xl mx-auto px-6 py-16 relative z-10 mx-4 mb-8">
                        ...
                        >
                            ...
                            <div className="p-6 text-center">
                                ...
                                <div
                                    ...
                                    style={{
                                        maxHeight: expandedCard === tip.id ? "400px" : "80px",
                                    }}
                                >
                ...
                {lifestyleTips.length > 6 && (
                    ...
                    >
                        ...
                        <svg
                            className={`w-6 h-6 transition-transform duration-300 ${visibleCards < lifestyleTips.length ? "animate-bounce group-hover:translate-y-1" : "rotate-180 group-hover:-translate-y-1"}`}
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        >
